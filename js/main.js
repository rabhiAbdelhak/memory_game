...
class MusicController{
      constructor(){
          this.backMusic = new Audio('../sounds/creepy.mp3');
          this.flipSound = new Audio('../sounds/flip.wav');
          this.GoMusic  = new Audio('../sounds/gameOver.wav');
          this.MathMusic = new Audio('../sounds/match.wav');
          this.victoryMusic = new Audio('../sounds/victory.wav');
